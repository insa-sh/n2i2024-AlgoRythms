...
function checkAnswer(button, selectedAnswer, correctAnswer, explanation) {
    ...
    const nextButton = document.getElementById("next-btn");
    const choicesButtons = document.querySelectorAll(".choice-btn");
    const hommeImage = document.getElementById("homme");
    ...
    if (selectedAnswer === correctAnswer) {
        ...
        // Changer l'image pour un homme content
        hommeImage.src = "happy.png"; // Replace with the path to your happy image
        hommeImage.style.display = "block";
    } else {
        button.style.backgroundColor = "red"; // Mauvaise réponse
        resultContainer.textContent = `Mauvaise réponse. ${explanation}`;
        resultContainer.style.color = "red";

        // Changer l'image pour un homme triste/en colère
        hommeImage.src = "sad.png"; // Replace with the path to your sad/angry image
        hommeImage.style.display = "block";
    }
